...
環顧四周，想到所有的歷史和所有在這些大廳裡走過的傑出人才，真是令人著迷。在我們移步下一站之前，你可以四處看看。`;
    ...
    **停頓** 站在這裡，它提醒我們這座城市豐富的歷史織錦，以及它在塑造這位關鍵人物的生活和抱負中所扮演的重要角色。`;
                    break;
                case 3:
                    textContent.textContent = `歡迎回來！今天，讓我們踏上一段特別的旅程，探索同盟會（中國革命同盟會）在香港的重要歷史遺跡。
    
    1905年，著名革命家孫中山先生在日本東京創立了同盟會。同年，香港分會也隨之成立。這個本地組織在全港建立了一個秘密網絡，為革命者提供安全庇護所和活動基地。
    
    讓我們跟隨這些歷史人物的腳步，參觀見證了這段驚心動魄歷史的地方。我們將漫步於堅道、普慶坊、摩利臣山道、蘭桂坊和皇后大道等地，揭開那些塑造了香港在中國革命中關鍵角色的隱藏故事。
    
    在這些街道上，革命的種子被悄悄播下，為中國的未來孕育著巨大的變革。每一個轉角，每一棟建築，都可能曾是革命者們秘密會面、討論國家命運的地方。
    
    想像一下，在這些繁華的街道背後，曾經進行著怎樣驚心動魄的地下活動。那些看似平常的茶樓、商店，可能就是革命者們交換信息的秘密基地。
    
    我們將看到這座城市如何在中國歷史的關鍵時刻扮演了重要角色，為中國的獨立和民主化進程做出了不可磨滅的貢獻。
    
    讓我們帶著敬畏和好奇的心情，一同揭開香港在中國革命史上的神秘面紗，感受這座城市在風雲變幗的年代裡所承載的重要使命。`;
                    break;
                case 4:
